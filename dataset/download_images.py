...
where:
  INPUT_FILE is input csv file with dataset description, i.e. images.csv
  IMAGES_DIR is output directory where all images should be downloaded

Example:
  # create directory for images
  mkdir images
  # download images declared in images.csv
  python download_images.py --input_file=images.csv --output_dir=images
